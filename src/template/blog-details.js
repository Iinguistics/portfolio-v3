...
import reactNodeTemplate from '../data/images/blog/react-node-template/screen-recording-1.mp4';
...
const BlogDetails = ({data, pageContext}) => {
    ...
    const fetchMp4 = () =>{
      if(title === 'Connecting the client to the server'){
          setMp4(reactNodeTemplate);
      }
    }
                    ...
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2">
                            ...
                            <div className="post-single-title">
                                <h1 className="post-title">{title}</h1><blockquote><p>By James Goytia</p></blockquote>
                            </div>
                            <div className="post-content" dangerouslySetInnerHTML={{__html: html}}/>

                            <div class="thumbnail mt--90 mt_md--40 mt_sm--40 ">
