...
import spybookMp4 from '../data/project/video/spybook-preview.mp4';
...
const ProjectDetails = ({data}) => {
    ...
    const fetchMp4 = () =>{
      if(projectData.title === "Tech Factory"){
          ...
          setMp4(forkMp4);
      }else if(projectData.title === "Spybook"){
          setMp4(spybookMp4);
      }
    }
                        ...
                        <div className="col-lg-12">
                            <div className="inner">
                                            ...
                                            <div className="content-left">
                                             <Link to="/#portfolio" className="link-button mb-4"><span>Go Back</span></Link>
                                                ...
                                                <ul className="list_holder">
                                                    <li><span className="icon"><FiList />Stack:</span><span className="projectinfo">{projectData.category}</span></li>
                                                    { projectData.live === "N/A" ? 
                                                    <li><span className="icon"><FiGithub />Code:</span><span className="projectinfo"><a href={projectData.repo} target= "_blank" rel="noopener noreferrer">Visit Repo</a></span></li> : ( <>
                                                    <li><span className="icon"><FiGithub />Code:</span><span className="projectinfo"><a href={projectData.repo} target= "_blank" rel="noopener noreferrer">Visit Repo</a></span></li>
                                                    <li><span className="icon"><FiActivity />Live Site:</span><span className="projectinfo"><a href={projectData.live} target= "_blank" rel="noopener noreferrer">Visit Site</a></span></li>
                                                   </> ) }
                                                </ul>
                                ...
                                <div className="thumbnail mt--90 mt_md--40 mt_sm--40 ">
                                    <video autoPlay muted loop className="w-100"> <source src={mp4}  type="video/mp4"/>
