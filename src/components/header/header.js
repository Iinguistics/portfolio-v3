...
const Header = () => {
    ...
    const jamesLogo = headerQuery.file.childImageSharp.fixed;
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-9">
                                <div className="menu_wrapper">
                                    <Scrollspy className="mainmenuwrapper" items={['home','about', 'portfolio',  'guides' , 'contact']} currentClassName="is-current" offset={-200}>
                                        <li>
                                        ...
                                        <li>
                                            <a className="menu-hover-link" href="/#guides">
                                                <span className="hover-item">
