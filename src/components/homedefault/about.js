...
// height 480 file(relativePath: {eq: "images/banner/self-portrait-1.png"})
const About = ( ) => {
    const aboutQueryData = useStaticQuery(graphql`
        query AboutDefaultQuery {
            ...
            file(relativePath: {eq: "images/banner/jg-headshot-small.png"}) {
                childImageSharp {
                  fixed (quality: 100, width: 518, height: 625) {
                        ...
                        <div className="inner">
                            <div className="content">
                                ...
                                <div className="button-group mt--30">
                                    {downloadButton && <a className="rn-button wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1000ms" href="/resume.pdf" target= "_blank" rel="noopener noreferrer"><span>{downloadButton}</span></a>}
                                </div>
                            </div>
                        </div>
                    </div>
