...
import astroSpaceMp4 from '../data/project/video/astro-space.mp4';
						...
						<div className='col-lg-12'>
							<div className='inner'>
									...
									<div className='row'>
										<div className='col-lg-12 col-md-12 col-12'>
											<div className='content-left'>
												...
												<div className='page-top'>
													<h1 className='title_holder'>Astrospace</h1>
												</div>
												<h3 className='mt--20'>Details</h3>
												<ul className='list_holder'>
													<li>
														...
														<span className='projectinfo'>
															React, Tailwind, Nasa APOD, LandSat & Rover API's,
															Axios
														</span>
													</li>
													<li>
														...
														<span className='projectinfo'>
															<a
																href='https://github.com/Iinguistics/astrospace'
																target='_blank'
																rel='noopener noreferrer'
															>
																Visit Repo
													...
													<li>
														...
														<span className='projectinfo'>
															<a
																href='https://astro-space.netlify.app/'
																target='_blank'
																rel='noopener noreferrer'
															>
																Visit Site
												...
												<p className='mt--20'>
													Astronomy app, to learn about the stars, planets.
													Enter any latitude and longitude coordinates & see a
													bird's eye view from a nasa satellite of your
													coordinates.
												</p>
											</div>
										</div>
								...
								<div className='thumbnail mt--90 mt_md--40 mt_sm--40 '>
									<video autoPlay muted loop className='w-100'>
										{' '}
										<source src={astroSpaceMp4} type='video/mp4' />
										Sorry, your browser doesn't support embedded videos.
									</video>
								</div>
							</div>
